import useVideoFileDrop from "@/hooks/useVideoFileDrop";
...
const DropzoneSection: React.FC<DropzoneSectionProps> = ({ setVideoFile }) => {
  ...
  return (
    ...
    >
      ...
      <label
        htmlFor="videoFile"
        className="w-52 h-9 cursor-pointer font-bold text-base bg-grayscale-5 text-grayscale-50 rounded-[10px] flex flex-col justify-center items-center"
      >
        컴퓨터에서 파일 선택
      </label>
      <input
